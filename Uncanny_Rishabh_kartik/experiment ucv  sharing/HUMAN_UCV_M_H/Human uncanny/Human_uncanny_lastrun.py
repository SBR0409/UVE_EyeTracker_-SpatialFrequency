...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='E:\\Visual_Cognition\\Uncanny_Rishabh_kartik\\experiment ucv  sharing\\HUMAN_UCV_M_H\\Human uncanny\\Human_uncanny_lastrun.py',
