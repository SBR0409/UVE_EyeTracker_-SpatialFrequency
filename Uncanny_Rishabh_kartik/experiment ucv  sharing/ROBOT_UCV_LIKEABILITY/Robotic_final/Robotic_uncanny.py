...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='E:\\Visual_Cognition\\Uncanny_Rishabh_kartik\\experiment ucv  sharing\\ROBOT_UCV_LIKEABILITY\\Robotic_final\\Robotic_uncanny.py',
