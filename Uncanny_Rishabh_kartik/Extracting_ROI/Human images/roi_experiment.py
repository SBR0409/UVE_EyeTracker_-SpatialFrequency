...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\karti\\OneDrive\\Desktop\\IP\\experiment ucv  sharing\\HUMAN_UCV_LIKEABILITY\\Human uncanny\\roi_experiment.py',
...
whole_image = visual.Rect(
    ...
    lineWidth=2.0,     colorSpace='rgb',  lineColor=[-0.0275, 0.9765, -1.0000], fillColor=[0.0000, 0.0000, 0.0000],
...
mouth = visual.Rect(
    win=win, name='mouth',
    width=(0.12, 0.04)[0], height=(0.12, 0.04)[1],
    ori=0.0, pos=(0, -0.028), anchor='center',
...
nose = visual.Rect(
    win=win, name='nose',
    width=(0.10, 0.036)[0], height=(0.10, 0.036)[1],
    ori=0.0, pos=(0, 0.013), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor=[-1.0000, -1.0000, 1.0000], fillColor=[0.0000, 0.0000, 0.0000],
    opacity=0.4, depth=-3.0, interpolate=True)
eyes = visual.Rect(
    win=win, name='eyes',
    width=(0.18, 0.035)[0], height=(0.18, 0.035)[1],
    ori=0.0, pos=(0.008, 0.053), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor=[1.0000, -1.0000, 1.0000], fillColor=[0.0000, 0.0000, 0.0000],
    opacity=0.4, depth=-4.0, interpolate=True)
forehead = visual.Rect(
    win=win, name='forehead',
    width=(0.17, 0.045)[0], height=(0.17, 0.045)[1],
    ori=0.0, pos=(0.008, 0.1), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor=[1.0000, -1.0000, -1.0000], fillColor=[0.0000, 0.0000, 0.0000],
    opacity=0.4, depth=-5.0, interpolate=True)
...
for thisTrial in trials:
    ...
    trialComponents = [whole_image, image, mouth, nose, eyes, forehead]
